...
Model 2 has the highest accuracy and the highest area under the ROC curve.  I will use model 2 to build a muliple linear regression model to predict the claim amount.
